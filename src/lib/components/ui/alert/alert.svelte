	...
	export const alertVariants = tv({
		...
		variants: {
			variant: {
				...
				error:
					'border-red-200 bg-red-50 text-red-800 *:data-[slot=alert-description]:text-red-700 *:[svg]:text-red-400',
				destructive:
					'border-red-200 bg-red-50 text-red-800 *:data-[slot=alert-description]:text-red-700 *:[svg]:text-red-400',
				warning:
					'border-yellow-200 bg-yellow-50 text-yellow-800 *:data-[slot=alert-description]:text-yellow-700 *:[svg]:text-yellow-400',
				info: 'border-blue-200 bg-blue-50 text-blue-800 *:data-[slot=alert-description]:text-blue-700 *:[svg]:text-blue-400',
				success:
					'border-green-200 bg-green-50 text-green-800 *:data-[slot=alert-description]:text-green-700 *:[svg]:text-green-400',
			},
		},
		defaultVariants: {
			variant: 'default',
