  ...
  <div class="px-2 py-3 sm:px-0 sm:py-6">
    <div class="border-4 border-dashed border-gray-200 rounded-lg p-3 sm:p-6">
      ...
      <div v-if="inventoryStore.loading" class="text-center py-6 sm:py-8">
        <div class="inline-block animate-spin rounded-full h-6 w-6 sm:h-8 sm:w-8 border-b-2 border-blue-600"></div>
        <p class="mt-2 text-gray-600 text-sm sm:text-base">Loading inventory data...</p>
      </div>

      <!-- Error State -->
      <div v-else-if="inventoryStore.error" class="bg-red-50 border border-red-200 rounded-md p-3 sm:p-4 mb-4 sm:mb-6">
        <div class="flex">
      ...
      <div v-else>
              ...
              <div class="flex items-center">
                ...
                <div class="ml-3 sm:ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd class="text-base sm:text-lg font-medium text-gray-900">{{ inventoryStore.totalItems }}</dd>
                  </dl>
                </div>
              </div>
            </div>
              ...
              <div class="flex items-center">
                ...
                <div class="ml-3 sm:ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd class="text-base sm:text-lg font-medium text-gray-900">{{ inventoryStore.totalProducts }}</dd>
                  </dl>
                </div>
              </div>
            </div>
              ...
              <div class="flex items-center">
                ...
                <div class="ml-3 sm:ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd class="text-base sm:text-lg font-medium text-gray-900">{{ inventoryStore.lowStockItems.length }}</dd>
                  </dl>
                </div>
              </div>
            </div>
          ...
          <div class="bg-white overflow-hidden shadow rounded-lg">
            <div class="p-3 sm:p-5">
              <div class="flex items-center">
                ...
                <div class="ml-3 sm:ml-5 w-0 flex-1">
                  <dl>
                    <dt class="text-xs sm:text-sm font-medium text-gray-500 truncate">Stale Items</dt>
                    <dd class="text-base sm:text-lg font-medium text-gray-900">{{ staleItems.length }}</dd>
                  </dl>
                </div>
              </div>
            </div>
        ...
        <!-- Low Stock Alert -->
        <div v-if="inventoryStore.lowStockItems.length > 0" class="bg-yellow-50 border border-yellow-200 rounded-md p-3 sm:p-4 mb-4 sm:mb-6">
          <div class="flex">
            <div class="flex-shrink-0">
        ...
        <div v-if="staleItems.length > 0" class="bg-purple-50 border border-purple-200 rounded-md p-3 sm:p-4 mb-4 sm:mb-6">
          <div class="flex">
            <div class="flex-shrink-0">
              <svg class="h-4 w-4 sm:h-5 sm:w-5 text-purple-400" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-md">
          <div class="px-3 py-4 sm:px-6 sm:py-5">
            ...
            <p class="mt-1 max-w-2xl text-xs sm:text-sm text-gray-500">Recently updated inventory items</p>
          </div>
                ...
                <div class="flex items-center">
                  <div class="flex-shrink-0">
                    <div :class="[
                      ...
                      item.quantity <= item.low_stock_notice_quantity ? 'bg-yellow-400' : 'bg-green-400'
                    ]"></div>
                  </div>
                  <div class="ml-4">
